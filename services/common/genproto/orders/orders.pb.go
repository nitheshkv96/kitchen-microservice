...
type CreateOrderRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	CustonerID    int32                  `protobuf:"varint,1,opt,name=custonerID,proto3" json:"custonerID,omitempty"`
...
func (x *CreateOrderRequest) GetCustonerID() int32 {
	if x != nil {
		return x.CustonerID
	}
	return 0
...
const file_orders_proto_rawDesc = "" +
	...
	"\fOrderService\x12:\n" +
	"\vCreateOrder\x12\x13.CreateOrderRequest\x1a\x14.CreateOrderResponse\"\x00B&Z$github.com/nitheshkv96/common/ordersb\x06proto3"
